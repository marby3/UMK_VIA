...
// Interrupts disabled for v20x and v30x
unsigned char write_block_bin_v20x_v30x[] = {
    0xf3, 0x27, 0x00, 0x30, 0x93, 0xf7, 0x77, 0xf7, 0x73, 0x90, 0x07, 0x30,
    0x13, 0x07, 0xc5, 0x06, 0x0c, 0x43, 0x5c, 0x43, 0x83, 0x12, 0x87, 0x00,
    0x03, 0x13, 0xa7, 0x00, 0x2e, 0x93, 0xb7, 0x06, 0x01, 0x00, 0xd4, 0xc3,
    0x33, 0x86, 0x55, 0x00, 0x94, 0x43, 0x85, 0x8a, 0xf5, 0xfe, 0x94, 0x43,
    0x89, 0x8a, 0xf5, 0xfe, 0x54, 0x47, 0x94, 0xc1, 0x94, 0x43, 0x89, 0x8a,
    0xf5, 0xfe, 0x91, 0x05, 0x11, 0x07, 0xe3, 0xc9, 0xc5, 0xfe, 0xb7, 0x06,
    0x20, 0x00, 0xd4, 0xc3, 0x83, 0xa6, 0xc5, 0xff, 0xe3, 0xca, 0x65, 0xfc,
    0xfd, 0x56, 0x14, 0xc1, 0xf3, 0x27, 0x00, 0x30, 0x93, 0xe7, 0x87, 0x08,
    0x73, 0x90, 0x07, 0x30, 0x82, 0x80, 0x01, 0x00
};
...
static int B003FunBlockWrite( void * dev, uint32_t address_to_write, const uint8_t * data, uint32_t len )
{
	...
	if( iss->target_chip->protocol == PROTOCOL_DEFAULT && IsAddressFlash( address_to_write ) )
	{
		...
		while( data_pos < len )
		{
			...
			{
				WriteOpArb( eps, write_block_bin_v20x_v30x, sizeof(write_block_bin_v20x_v30x) );
			}
			else
			{
